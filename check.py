...
def criar_seq():
    ...
    i1=7;i2=6;i3=5;i4=4;i5=3;i6=2;i7=1;i8=0;i9=0;i10=2;i11=1;i12=0;
    p1=7;p2=6;p3=5;p4=4;p5=3;p6=2;p7=1;p8=0;p9=0;p10=2;p11=1;p12=0;
    f1=7;f2=6;f3=5;f4=4;f5=3;f6=2;f7=1;f8=0;f9=0;f10=2;f11=1;f12=0;
        ...
        if (f9 != f10 and f9 != f11 and f9 != f12):            
            if (f10 != f11 and f10 != f12):            
                if (f11 != f12):    
                    ...
                    if (x % 100000) == 0:
                        xx=xx+1     
                        sql1 = "INSERT INTO servidor_job (id, total_palavras, uuid, mnemonic, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, data_alteracao) VALUES"
                        f = open("C:/Users/roney/Documents/GitHub/python_bsc/insert_"+str(xx)+".sql", "a")
                        f.write(sql1+'\n')
                        f.close()  
                    if (x == 1):
                        xx=xx+1     
                    ...
                    aa=aa+1
                    if (aa % 100000) == 0:
                        sql = "(NULL, "+str(total_palavras)+", '', '', "+str(i1)+", "+str(i2)+", "+str(i3)+", "+str(i4)+", "+str(i5)+", "+str(i6)+", "+str(i7)+", "+str(i8)+", "+str(i9)+", "+str(i10)+", "+str(i11)+", "+str(i12)+", "+str(i1)+", "+str(i2)+", "+str(i3)+", "+str(i4)+", "+str(i5)+", "+str(i6)+", "+str(i7)+", "+str(i8)+", "+str(i9)+", "+str(i10)+", "+str(i11)+", "+str(i12)+", "+str(f1)+", "+str(f2)+", "+str(f3)+", "+str(f4)+", "+str(f5)+", "+str(f6)+", "+str(f7)+", "+str(f8)+", "+str(f9)+", "+str(f10)+", "+str(f11)+", "+str(f12)+", now());"
                    else:
                        sql = "(NULL, "+str(total_palavras)+", '', '', "+str(i1)+", "+str(i2)+", "+str(i3)+", "+str(i4)+", "+str(i5)+", "+str(i6)+", "+str(i7)+", "+str(i8)+", "+str(i9)+", "+str(i10)+", "+str(i11)+", "+str(i12)+", "+str(i1)+", "+str(i2)+", "+str(i3)+", "+str(i4)+", "+str(i5)+", "+str(i6)+", "+str(i7)+", "+str(i8)+", "+str(i9)+", "+str(i10)+", "+str(i11)+", "+str(i12)+", "+str(f1)+", "+str(f2)+", "+str(f3)+", "+str(f4)+", "+str(f5)+", "+str(f6)+", "+str(f7)+", "+str(f8)+", "+str(f9)+", "+str(f10)+", "+str(f11)+", "+str(f12)+", now()),"
                    #mycursor.execute(sql);mydb.commit();mycursor.close();mydb.close();
